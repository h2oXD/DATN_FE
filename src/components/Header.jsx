          ...
          <div>
            <div className="d-flex align-items-center">
              <div className="dropdown me-2">
                <a href="#langaugeModal" className="text-inherit me-2" data-bs-toggle="modal">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-globe text-gray-500" viewBox="0 0 16 16">
                    <path
              ...
              <a href="#" className="btn btn-outline-dark shadow-sm me-1">Đăng nhập</a>
              <a href="#" className="btn btn-dark d-none d-md-block">Đăng ký</a>
            </div>
          </div>
          <button
