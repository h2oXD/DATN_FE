...
export default function NewCourse() {
    ...
    if (!courses) {
        return (
            <>
                <div className="p-4">Không có dữ liệu khoá học mới</div>
            </>
        );
    }
    return (
                        ...
                        <div className="col-lg-3 col-12" key={index}>
                            <div className="card d-flex rounded shadow-none">
                                <div className="p-2" style={{ position: "relative" }}>
                                    {" "}
                                    {/* Thêm style cho div cha */}
                                    {course.is_enrollment ? (
                                        <>
                                ...
                                <div className="px-2 py-1">
                                    <h4 className="m-0 h4">
                                        <div className="d-flex justify-content-between">
                                            <div>
                                                {course.is_enrollment ? (<Link
                                                    to={`/student/course/${course.id}`}
                                                    className="text-inherit"
                                                >
                                                    {course.title}
                                                </Link>) : (<Link
                                                    to={`/student/home/${course.id}/coursedetail`}
                                                    className="text-inherit"
                                                >
                                                    {course.title}
                                                </Link>)}
                                    ...
                                    <ul className="list-inline fs-6 mb-0 d-flex justify-content-between align-items-center pb-2">
                                        <li className="list-inline-item d-flex flex-column">
                                            {course.is_free == 0 && course.price_sale && (
                                                <>
                                                    <span className="h5 m-0">
                                                        ...
                                                        <span className="fw-bold">
                                                            {parseInt(course.price_sale).toLocaleString() +
                                                                "đ"}
                                                        </span>
                                                    </span>
                                                </>
                                            ...
                                            {course.is_free == 1 && (
                                                <>
                                                    <span className="fw-bold h5 m-0">Miễn phí</span>
                                                </>
                                            )}
